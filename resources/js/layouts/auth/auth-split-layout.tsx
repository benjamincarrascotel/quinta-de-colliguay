        ...
        <div className="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
                ...
                <Link href={home()} className="relative z-20 flex items-center text-lg font-medium">
                    <div className="mr-3 flex items-center justify-center" style={{ width: 200, height: 200 }}>
                        <AppLogoIcon variant="logo" size={200} fitContainer />
                    </div>
                    {name}
                </Link>
                {quote && (
                ...
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
                    <Link href={home()} className="relative z-20 flex items-center justify-center lg:hidden">
                        <div className="flex items-center justify-center" style={{ width: 160, height: 160 }}>
                            <AppLogoIcon variant="logo" size={160} fitContainer />
                        </div>
                    </Link>
